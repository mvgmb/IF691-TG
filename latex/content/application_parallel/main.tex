\subsection{Parallel and Sequential Application Clients}
...
\input{content/application_parallel/latency_and_throughput}
\clearpage

\input{content/application_parallel/cpu}
\clearpage

\input{content/application_parallel/memory}
\clearpage
